...
loader = TextLoader(file_path='/Users/leechaejun/selfstudy-repo/lectures/agent/data/bookstoreChatManual.txt', encoding='utf-8')
...
# 텍스트 분할
file_path = '/Users/leechaejun/selfstudy-repo/lectures/agent/data/bookstoreChatManual.txt'
...
optimal_chunk_size = max_char_length + 10
...
# 프롬프트 작성
system_prompt = """당신은 친절한 서점 플랫폼 직원입니다. 주어진 컨텍스트
